...
export const CATEGORY_SEO_ALIASES = {
  ...
  "data-analyst": { canonicalSlug: "data-and-ai", name: "Data Analyst" },
  ...
  developer: { canonicalSlug: "software-engineering", name: "Developer" },
  writing: { canonicalSlug: "writing-and-editorial", name: "Writing" },
  "qa-testing": { canonicalSlug: "qa-and-testing", name: "QA Testing" },
};
